...
class EndpointIdentity:
    ...
    public_key_b64: str = field(init=False)
    ...
    def from_private_bytes(
        ...
        *,
        ...
        return cls(
            agent_id=agent_id,
            _private_key=private_cls.from_private_bytes(private_key_raw),
        )
    ...
    def private_key_bytes_for_secure_store(self) -> bytes:
        """Return raw endpoint key bytes only to an endpoint-side secure store."""
        serialization, _ = _crypto()
...
def write_development_identity_file(
    ...
    *,
    ...
    """Development-only private key persistence, prohibited for production v1.3."""
    ...
    payload = {
        ...
        "private_key_b64": _b64(identity.private_key_bytes_for_secure_store()),
    }
